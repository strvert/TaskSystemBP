...
DEFINE_FUNCTION(UTSBTaskDataLibrary::execMakeTaskStructResult)
{
	...
	if (!ValueProp || !ValuePtr)
	{
		...
		P_NATIVE_BEGIN;
			static_cast<FTSBTaskData*>(RESULT_PARAM)->ResultValue.Reset();
		P_NATIVE_END;
	}
	else
	{
		P_NATIVE_BEGIN;
			static_cast<FTSBTaskData*>(RESULT_PARAM)->ResultValue.InitializeAs(
				ValueProp->Struct,
